...
; examples: 
; `head ./fasm/hello_world 50`
; `head README.md 24`
;
; Assembler: FASM
; Author: James Plummer <jamesp2001@live.co.uk>
; Source: https://github.com/jamesukiyo/asm/blob/master/fasm/head.asm
...
line_count rq 1               ; track line count, qword so 8 bytes
max_lines rq 1                ; arg 2 number of lines, qword so 8 bytes
...
segment readable
; ERRORS
usage_err db "Incorrect or broken args provided. Please provide 2 args that are the full name of the file to preview and the number of lines to display."
