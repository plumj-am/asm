...
; examples: 
; `word_count ./fasm/hello_world`
; `word_count README.md`
;
; Assembler: FASM
; Author: James Plummer <jamesp2001@live.co.uk>
; Source: https://github.com/jamesukiyo/asm/blob/master/fasm/word_count.asm
...
output_len = $ - output
; ERRORS
usage_err db "Incorrect or broken args provided. Please provide a single arg that is the full name of the file to count words for."
