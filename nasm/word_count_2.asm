; word_count_2: count the number of words in a file. This is an improved version
...
; examples: 
; `word_count_2 ./nasm/hello_world`
; `word_count_2 README.md`
;
; Assembler: NASM
; Author: James Plummer <jamesp2001@live.co.uk>
; Source: https://github.com/jamesukiyo/asm/blob/master/nasm/word_count_2.asm
...
%macro syscall_write 3
    ; %1 = file descriptor, %2 = buffer, %3 = length
    mov rax, 1                  ; sys_write
